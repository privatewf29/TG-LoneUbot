...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/W29F/TG-LoneUbot.git")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "TG-LoneUbot")
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("Deploy Userbot Mu Sendiri [Tekan Disini](https://github.com/W29F/TG-LoneUbot.git)")
            else:
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@UserButt"):
                ...
                result = builder.article(
                    ...
                    text="{}\n\n**✥ Jumlah Module Yang Tersedia :** `{}`\n               \n**✥ Daftar Modul TG-LoneUbot :** \n".format(
                        "**✗ TG-LoneUbot Main Menu ✗**",
                        len(dugmeler),
                    ),
                    buttons=buttons,
                    link_preview=False,
                ...
                result = builder.article(
                    "**✗ TG-LoneUbot ✗**",
                    text="""**Buat Userbot Anda Sendiri Dengan Cara :** [Tekan Disini](https://github.com/W29F/TG-LoneUbot)""",
                    buttons=[
                        [
                            custom.Button.url(
                                "Repo Userbot-Man",
                                "https://github.com/W29F/TG-LoneUbot"),
                            custom.Button.url(
                                "Owner Repo",
                                "t.me/privatener")],
                    ],
