...
async def killdabot(event):
    ...
    await event.edit("`Mematikan TG-LoneUbot....`")
...
async def killdabot(event):
    await event.edit("`Restarting TG-LoneUbot...`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID, "#RESTARTBOT \n" "`TG-LoneUbot Telah Di Restart`"
        )
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[Userbot Repo](https://github.com/W29F/TG-LoneUbot/blob/TG-LoneUbot/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        f"**Hey**, __I am using__ 🔥 **TG-LoneUbot** 🔥\n\n"
        f"      __Thanks For Using me__\n\n"
        f"✣ **Userbot Version :** `4.1@TG-LoneUbot`\n"
        f"✣ **Group Support :** [Sharing Userbot](t.me/privatener)\n"
        f"✣ **Owner Repo :** [NerSup](t.me/privatener)\n"
        f"✣ **Repo :** [TG-LoneUbot](https://github.com/W29F/TG-LoneUbot)\n"
    )
...
CMD_HELP.update(
    {
        "sleep": "**Plugin : **`sleep`\
        \n\n  •  **Syntax :** `.sleep`\
        \n  •  **Function : **Biarkan TG-LoneUbot tidur selama beberapa detik \
    "
    }
)
...
CMD_HELP.update(
    {
        "repo": "**Plugin : **`Repository TG-LoneUbot`\
        \n\n  •  **Syntax :** `.repo`\
        \n  •  **Function : **Menampilan link Repository TG-LoneUbot\
        \n\n  •  **Syntax :** `.string`\
        \n  •  **Function : **Menampilan link String TG-LoneUbot\
    "
    }
)
