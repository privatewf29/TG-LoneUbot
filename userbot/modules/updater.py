...
async def deploy(event, repo, ups_rem, ac_br, txt):
    if HEROKU_API_KEY is not None:
        ...
        if build.status == "failed":
            ...
            await event.edit(
                "`TG-LoneUbot Berhasil Di Deploy!"
        ...
        if BOTLOG:
            await event.client.send_message(
                BOTLOG_CHATID, "#BOT \n" "`TG-LoneUbot Berhasil Di Update`"
            )
...
async def update(event, repo, ups_rem, ac_br):
    ...
    await event.edit("**✥ TG-LoneUbot** `Berhasil Di Update!`")
    await asyncio.sleep(1)
    await event.edit("**✥ TG-LoneUbot** `Sedang di Restart....`")
    await asyncio.sleep(1)
    ...
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID, "#BOT \n" "**TG-LoneUbot Sedang Di Perbarui**"
        )
...
async def upstream(event):
    ...
    if changelog == "" and force_update is False:
        await event.edit(f"\n**✥ TG-LoneUbot Sudah Versi Terbaru**\n")
        await asyncio.sleep(15)
        await event.delete()
        return repo.__del__()

    if conf is None and force_update is False:
        changelog_str = f"**✥ Pembaruan Untuk TG-LoneUbot [{ac_br}] :\n\n✥ Pembaruan:**\n`{changelog}`"
    ...
    if force_update:
        ...
        await event.edit("`✣ Proses Update TG-LoneUbot, Loading....1%`")
        await event.edit("`✣ Proses Update TG-LoneUbot, Loading....12%`")
        await event.edit("`✣ Proses Update TG-LoneUbot, Loading....25%`")
        await event.edit("`✣ Proses Update TG-LoneUbot, Loading....46%`")
        await event.edit("`✣ Proses Update TG-LoneUbot, Loading....76%`")
        await event.edit("`✣ Proses Update TG-LoneUbot, Updating...92%`")
        await event.edit("`✣ Proses Update TG-LoneUbot, Tunggu Sebentar....100%`")
    if conf == "now":
