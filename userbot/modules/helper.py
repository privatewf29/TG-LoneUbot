...
async def usit(e):
    await e.edit(
        ...
        "\n[Telegram](t.me/kepsexlendirbot)"
        "\n[Repo](https://github.com/W29F/TG-LoneUbot)"
    )
...
async def var(m):
    await m.edit(
        ...
        "\n[DAFTAR VARS](https://raw.githubusercontent.com/W29F/TG-LoneUbot/TG-LoneUbot/varshelper.txt)"
    )
